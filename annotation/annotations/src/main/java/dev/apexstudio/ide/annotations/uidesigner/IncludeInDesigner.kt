...
package dev.apexstudio.ide.annotations.uidesigner

/**
 * Indicates that the view (whose view adapter is annotated with [ViewAdapter]
 * [dev.apexstudio.ide.annotations.inflater.ViewAdapter] and [IncludeInDesigner]) should be
...
annotation class IncludeInDesigner(val group: Group) {
  ...
  enum class Group {
    ...
    LAYOUTS,
    /** Includes Google Material layouts. */
    GOOGLE
  }
}
