...
import dev.apexstudio.ide.editor.R.layout
import dev.apexstudio.ide.editor.databinding.LayoutPopupMenuItemBinding
import dev.apexstudio.ide.editor.ui.EditorActionsMenu.ActionsListAdapter.VH
...
open class EditorActionsMenu(val editor: IDEEditor) :
  ...
  protected open fun onCreateActionData(): ActionData {
    ...
    data.put(dev.apexstudio.ide.models.Range::class.java, editor.cursorLSPRange)
    data.put(
