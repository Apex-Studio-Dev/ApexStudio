...
package dev.apexstudio.ide.editor.schemes

import android.content.Context
import dev.apexstudio.ide.editor.language.treesitter.TreeSitterLanguageSpec
import dev.apexstudio.ide.editor.language.treesitter.predicates.AnyOfPredicate
import dev.apexstudio.ide.editor.language.treesitter.predicates.EqualPredicate
import dev.apexstudio.ide.editor.language.treesitter.predicates.MatchPredicate
import dev.apexstudio.ide.editor.language.treesitter.predicates.NotEqualPredicate
import dev.apexstudio.ide.editor.language.treesitter.predicates.NotMatchPredicate
