...
package dev.apexstudio.ide.editor.language.cpp;

import static dev.apexstudio.ide.syntax.colorschemes.SchemeAndroidIDE.LITERAL;
import static dev.apexstudio.ide.syntax.colorschemes.SchemeAndroidIDE.OPERATOR;
import static dev.apexstudio.ide.syntax.colorschemes.SchemeAndroidIDE.TEXT_NORMAL;
import static dev.apexstudio.ide.syntax.colorschemes.SchemeAndroidIDE.TYPE_NAME;
import static dev.apexstudio.ide.syntax.colorschemes.SchemeAndroidIDE.forComment;
import static dev.apexstudio.ide.syntax.colorschemes.SchemeAndroidIDE.forKeyword;
import static dev.apexstudio.ide.syntax.colorschemes.SchemeAndroidIDE.forString;
import static io.github.rosemoe.sora.lang.styling.TextStyle.makeStyle;

import dev.apexstudio.ide.editor.language.incremental.BaseIncrementalAnalyzeManager;
import dev.apexstudio.ide.editor.language.incremental.IncrementalToken;
import dev.apexstudio.ide.editor.language.incremental.LineState;
import dev.apexstudio.ide.lexers.cpp.CPP14Lexer;
