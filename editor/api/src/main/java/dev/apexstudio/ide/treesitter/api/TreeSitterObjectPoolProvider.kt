...
import dev.apexstudio.ide.treesitter.api.TreeSitterLookaheadIterator
import dev.apexstudio.ide.treesitter.api.TreeSitterNativeLanguage
import dev.apexstudio.ide.treesitter.api.TreeSitterNode
import dev.apexstudio.ide.treesitter.api.TreeSitterParser
import dev.apexstudio.ide.treesitter.api.TreeSitterPoint
import dev.apexstudio.ide.treesitter.api.TreeSitterQuery
import dev.apexstudio.ide.treesitter.api.TreeSitterQueryCapture
import dev.apexstudio.ide.treesitter.api.TreeSitterQueryCursor
import dev.apexstudio.ide.treesitter.api.TreeSitterQueryMatch
import dev.apexstudio.ide.treesitter.api.TreeSitterQueryPredicateStep
import dev.apexstudio.ide.treesitter.api.TreeSitterRange
import dev.apexstudio.ide.treesitter.api.TreeSitterTree
import dev.apexstudio.ide.treesitter.api.TreeSitterTreeCursor
import dev.apexstudio.ide.treesitter.api.TreeSitterTreeCursorNode
import dev.apexstudio.ide.utils.RecyclableObjectPool
import dev.apexstudio.ide.utils.RecyclableObjectPool.Companion.CAPACITY_DEFAULT
import dev.apexstudio.ide.utils.RecyclableObjectPool.Companion.CAPACITY_MINI
import dev.apexstudio.ide.utils.newRecyclableObjectPool
import dev.apexstudio.ide.utils.uncheckedCast
