...
package dev.apexstudio.ide.treesitter.api
...
class TreeSitterObjectFactory : TSObjectFactory {
  ...
  override fun createInputEdit(startByte: Int, oldEndByte: Int, newEndByte: Int,
    ...
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterInputEdit.obtain(
      startByte,
      oldEndByte,
      newEndByte,
      startPoint,
  ...
  override fun createParser(parserPointer: Long): TSParser {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterParser.obtain(parserPointer)
  }

  override fun createQuery(queryPointer: Long): TSQuery {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterQuery.obtain(queryPointer)
  }

  override fun createQueryCursor(pointer: Long): TSQueryCursor {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterQueryCursor.obtain(pointer)
  }

  override fun createPoint(row: Int, column: Int): TSPoint {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterPoint.obtain(row, column)
  }

  override fun createRange(startByte: Int, endByte: Int, startPoint: TSPoint,
    endPoint: TSPoint?): TSRange {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterRange.obtain(startByte, endByte, startPoint, endPoint)
  }
  ...
  override fun createTree(pointer: Long): TSTree {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterTree.obtain(pointer)
  }

  override fun createTreeCursor(pointer: Long): TSTreeCursor {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterTreeCursor.obtain(pointer)
  }

  override fun createNode(context0: Int, context1: Int, context2: Int, context3: Int, id: Long,
    treePointer: Long): TSNode {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterNode.obtain(context0, context1, context2, context3, id, treePointer)
  }

  override fun createQueryCapture(node: TSNode?, index: Int): TSQueryCapture {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterQueryCapture.obtain(node, index)
  }

  override fun createQueryMatch(id: Int, patternIndex: Int,
    captures: Array<TSQueryCapture?>?): TSQueryMatch {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterQueryMatch.obtain(id, patternIndex, captures)
  }

  override fun createQueryPredicateStep(type: Int, valueId: Int): TSQueryPredicateStep {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterQueryPredicateStep.obtain(type, valueId)
  }
  ...
  override fun createTreeCursorNode(
    ...
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterTreeCursorNode.obtain(type, name, startByte, endByte)
  }

  override fun createLookaheadIterator(pointer: Long): TSLookaheadIterator {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterLookaheadIterator.obtain(pointer)
  }

  override fun createLanguage(name: String?, pointers: LongArray?): TSLanguage {
    return _root_ide_package_.dev.apexstudio.ide.treesitter.api.TreeSitterNativeLanguage.obtain(name, pointers)
  }
