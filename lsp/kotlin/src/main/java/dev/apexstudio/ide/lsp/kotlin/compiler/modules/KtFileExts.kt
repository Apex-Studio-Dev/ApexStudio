package dev.apexstudio.ide.lsp.kotlin.compiler.modules
 ...
 * [dev.apexstudio.ide.lsp.kotlin.compiler.read] lock, so code inside an `analyze` block must never
 * call [dev.apexstudio.ide.lsp.kotlin.compiler.write] — read → write on the same thread deadlocks.
 */
