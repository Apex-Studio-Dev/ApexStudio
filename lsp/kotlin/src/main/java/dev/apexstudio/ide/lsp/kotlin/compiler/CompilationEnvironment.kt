package dev.apexstudio.ide.lsp.kotlin.compiler

import dev.apexstudio.ide.lsp.api.ILanguageClient
import dev.apexstudio.ide.lsp.kotlin.compiler.index.KtSymbolIndex
import dev.apexstudio.ide.lsp.kotlin.compiler.modules.AbstractKtModule
import dev.apexstudio.ide.lsp.kotlin.compiler.modules.AnalysisPreemptedException
import dev.apexstudio.ide.lsp.kotlin.compiler.modules.KtModule
import dev.apexstudio.ide.lsp.kotlin.compiler.modules.asFlatSequence
import dev.apexstudio.ide.lsp.kotlin.compiler.modules.backingFilePath
import dev.apexstudio.ide.lsp.kotlin.compiler.registrar.AnalysisApiServiceProviders
import dev.apexstudio.ide.lsp.kotlin.compiler.registrar.LspAnalysisApiServiceRegistrar
import dev.apexstudio.ide.lsp.kotlin.compiler.services.ProjectStructureProvider
import dev.apexstudio.ide.lsp.kotlin.compiler.services.ResolutionScopeProvider
import dev.apexstudio.ide.lsp.kotlin.diagnostic.collectDiagnosticsFor
import dev.apexstudio.ide.lsp.kotlin.utils.SymbolVisibilityChecker
import dev.apexstudio.ide.lsp.kotlin.utils.toVirtualFileOrNull
import dev.apexstudio.ide.projects.FileManager
import dev.apexstudio.ide.projects.api.Workspace
import dev.apexstudio.ide.utils.KeyedDebouncingAction
