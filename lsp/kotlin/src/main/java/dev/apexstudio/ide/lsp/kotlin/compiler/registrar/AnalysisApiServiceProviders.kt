package dev.apexstudio.ide.lsp.kotlin.compiler.registrar

import dev.apexstudio.ide.lsp.kotlin.compiler.services.AnalysisPermissionOptions
import dev.apexstudio.ide.lsp.kotlin.compiler.services.AnnotationsResolverFactory
import dev.apexstudio.ide.lsp.kotlin.compiler.services.DeclarationProviderFactory
import dev.apexstudio.ide.lsp.kotlin.compiler.services.DeclarationProviderMerger
import dev.apexstudio.ide.lsp.kotlin.compiler.services.ModificationTrackerFactory
import dev.apexstudio.ide.lsp.kotlin.compiler.services.ModuleDependentsProvider
import dev.apexstudio.ide.lsp.kotlin.compiler.services.NoOpAsyncExecutionService
import dev.apexstudio.ide.lsp.kotlin.compiler.services.PackagePartProviderFactory
import dev.apexstudio.ide.lsp.kotlin.compiler.services.PackageProviderFactory
import dev.apexstudio.ide.lsp.kotlin.compiler.services.PackageProviderMerger
import dev.apexstudio.ide.lsp.kotlin.compiler.services.PlatformSettings
