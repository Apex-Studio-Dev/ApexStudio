...
package dev.apexstudio.ide.testing.tooling

import ch.qos.logback.core.CoreConstants
import dev.apexstudio.ide.testing.tooling.models.ToolingApiTestLauncherParams
import dev.apexstudio.ide.testing.tooling.models.ToolingApiTestScope
...
import dev.apexstudio.ide.tooling.api.messages.toLogLine
import dev.apexstudio.ide.tooling.api.sync.ProjectSyncHelper
import dev.apexstudio.ide.tooling.api.util.ToolingApiLauncher
import dev.apexstudio.ide.tooling.api.util.ToolingProps
import dev.apexstudio.ide.tooling.events.ProgressEvent
import dev.apexstudio.ide.utils.FileProvider
import dev.apexstudio.ide.utils.ILogger
...
//		cmd.add(
//			"-D${CoreConstants.STATUS_LISTENER_CLASS_KEY}=dev.apexstudio.ide.tooling.impl.util.LogbackStatusListener",
//		)
