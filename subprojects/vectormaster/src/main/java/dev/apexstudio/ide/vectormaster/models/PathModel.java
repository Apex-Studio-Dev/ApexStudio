package dev.apexstudio.ide.vectormaster.models;
...
import dev.apexstudio.ide.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
  ...
  public void buildPath(boolean useLegacyParser) {
    if (pathData != null) {
      if (useLegacyParser) {
        originalPath =
            dev.apexstudio.ide.vectormaster.utilities.legacyparser.PathParser
