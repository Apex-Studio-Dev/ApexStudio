...
import dev.apexstudio.ide.layouteditor.R.string
import dev.apexstudio.ide.layouteditor.adapters.LayoutListAdapter
import dev.apexstudio.ide.layouteditor.adapters.PaletteListAdapter
import dev.apexstudio.ide.layouteditor.databinding.ActivityLayoutEditorBinding
import dev.apexstudio.ide.layouteditor.editor.DesignEditor
import dev.apexstudio.ide.layouteditor.editor.DeviceConfiguration
import dev.apexstudio.ide.layouteditor.editor.DeviceSize
import dev.apexstudio.ide.layouteditor.editor.convert.ConvertImportedXml
import dev.apexstudio.ide.layouteditor.managers.DrawableManager
import dev.apexstudio.ide.layouteditor.managers.IdManager.clear
...
import dev.apexstudio.ide.layouteditor.utils.BitmapUtil.createBitmapFromView
import dev.apexstudio.ide.layouteditor.utils.Constants
import dev.apexstudio.ide.layouteditor.utils.FileCreator
import dev.apexstudio.ide.layouteditor.utils.FilePicker
import dev.apexstudio.ide.layouteditor.utils.FileUtil
import dev.apexstudio.ide.layouteditor.utils.SBUtils
import dev.apexstudio.ide.layouteditor.utils.SBUtils.Companion.make
import dev.apexstudio.ide.layouteditor.utils.Utils
import dev.apexstudio.ide.layouteditor.utils.doubleArgSafeLet
import dev.apexstudio.ide.layouteditor.views.CustomDrawerLayout
import java.io.File
