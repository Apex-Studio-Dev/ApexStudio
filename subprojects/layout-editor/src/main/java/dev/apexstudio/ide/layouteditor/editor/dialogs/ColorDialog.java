package dev.apexstudio.ide.layouteditor.editor.dialogs;
...
import dev.apexstudio.ide.layouteditor.databinding.LayoutColorDialogBinding;
import dev.apexstudio.ide.layouteditor.views.ColorView;
...
public class ColorDialog extends AttributeDialog
  ...
  public ColorDialog(Context context, String savedValue) {
    ...
    dev.apexstudio.ide.layouteditor.databinding.LayoutColorDialogBinding binding = LayoutColorDialogBinding.inflate(getDialog().getLayoutInflater());
