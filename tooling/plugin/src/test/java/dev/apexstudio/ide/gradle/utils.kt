...
package dev.apexstudio.ide.gradle

import dev.apexstudio.ide.buildinfo.BuildInfo
import dev.apexstudio.ide.tooling.api.LogSenderConfig._PROPERTY_IS_TEST_ENV
import dev.apexstudio.ide.tooling.api.LogSenderConfig._PROPERTY_MAVEN_LOCAL_REPOSITORY
...
internal fun writeInitScript(file: File, deps: List<File>) {
  ...
  file.bufferedWriter().use {
    it.write(
      ...
      apply plugin: dev.apexstudio.ide.gradle.AndroidIDEInitScriptPlugin
    """.trimIndent()
    )
  }
}
