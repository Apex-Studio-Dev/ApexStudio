...
package dev.apexstudio.ide.tooling.impl.progress

import dev.apexstudio.ide.tooling.events.StatusEvent
import dev.apexstudio.ide.tooling.events.configuration.ProjectConfigurationOperationResult.PluginApplicationResult
...
import dev.apexstudio.ide.tooling.events.transform.TransformOperationDescriptor.SubjectDescriptor
import dev.apexstudio.ide.tooling.events.transform.TransformOperationResult
...
import dev.apexstudio.ide.tooling.model.PluginIdentifier
...
class EventTransformer {
  companion object {
    ...
    ): dev.apexstudio.ide.tooling.events.OperationDescriptor? =
      when (descriptor) {
        null -> null
    ...
    ): dev.apexstudio.ide.tooling.events.configuration.ProjectConfigurationProgressEvent =
      dev.apexstudio.ide.tooling.events.configuration.ProjectConfigurationStartEvent(
    ...
    fun projectConfigurationFinish(
      ...
      dev.apexstudio.ide.tooling.events.configuration.ProjectConfigurationFinishEvent(
        displayName = event.displayName,
        eventTime = event.eventTime,
        descriptor = projectConfigurationDescriptor(event.descriptor),
    ...
    ): dev.apexstudio.ide.tooling.events.configuration.ProjectConfigurationOperationResult =
      dev.apexstudio.ide.tooling.events.configuration.ProjectConfigurationOperationResult(
    ...
    ): dev.apexstudio.ide.tooling.events.configuration.ProjectConfigurationOperationDescriptor =
      dev.apexstudio.ide.tooling.events.configuration.ProjectConfigurationOperationDescriptor(
    ...
    ): dev.apexstudio.ide.tooling.model.ProjectIdentifier =
      dev.apexstudio.ide.tooling.model.ProjectIdentifier(
        projectPath = project.projectPath,
        buildIdentifier =
          dev.apexstudio.ide.tooling.model.BuildIdentifier(project.buildIdentifier.rootDir)
      )
    ...
    ): dev.apexstudio.ide.tooling.events.download.FileDownloadResult =
      dev.apexstudio.ide.tooling.events.download.FileDownloadResult(
    ...
    ): dev.apexstudio.ide.tooling.events.download.FileDownloadOperationDescriptor =
      dev.apexstudio.ide.tooling.events.download.FileDownloadOperationDescriptor(
        descriptor.uri,
        descriptor.name,
    ...
    private fun taskResult(
    ...
    ): dev.apexstudio.ide.tooling.events.task.TaskOperationResult {

      // The order of conditions must not change here.

      if (result is TaskSuccessResult) {
        return dev.apexstudio.ide.tooling.events.task.TaskSuccessResult(
          result.isUpToDate,
          result.isFromCache,
          result.startTime,
          result.endTime,
      ...
      if (result is TaskFailureResult) {
        return dev.apexstudio.ide.tooling.events.task.TaskFailureResult(
          result.startTime,
          result.endTime
        )
      }
      ...
      if (result is TaskExecutionResult) {
        return dev.apexstudio.ide.tooling.events.task.TaskExecutionResult(
          result.startTime,
          result.endTime,
          result.isIncremental,
          result.executionReasons
      ...
      if (result is TaskSkippedResult) {
        return dev.apexstudio.ide.tooling.events.task.TaskSkippedResult(
          result.skipMessage,
          result.startTime,
          result.endTime
        )
      ...
      return dev.apexstudio.ide.tooling.events.task.TaskOperationResult(
        startTime = result.startTime,
        endTime = result.endTime
      )
    }
    ...
    ): dev.apexstudio.ide.tooling.events.task.TaskOperationDescriptor =
      dev.apexstudio.ide.tooling.events.task.TaskOperationDescriptor(
        dependencies =
    ...
    ): dev.apexstudio.ide.tooling.events.test.TestOperationDescriptor =
      dev.apexstudio.ide.tooling.events.test.TestOperationDescriptor(
        name = descriptor.name,
        displayName = descriptor.displayName
      )
    ...
    ): dev.apexstudio.ide.tooling.events.transform.TransformOperationDescriptor =
      dev.apexstudio.ide.tooling.events.transform.TransformOperationDescriptor(
        name = descriptor.name,
        displayName = descriptor.displayName,
    ...
    ): dev.apexstudio.ide.tooling.events.work.WorkItemOperationDescriptor =
      dev.apexstudio.ide.tooling.events.work.WorkItemOperationDescriptor(
        name = descriptor.name,
        displayName = descriptor.displayName,
    ...
    // ----------------------- DEFAULT ----------------------------------
    fun progress(event: ProgressEvent): dev.apexstudio.ide.tooling.events.ProgressEvent =
    ...
    ): dev.apexstudio.ide.tooling.events.ProgressEvent =
      DefaultStartEvent(
        eventTime = event.eventTime,
        displayName = event.displayName,
        descriptor = operationDescriptor(event.descriptor)!!
