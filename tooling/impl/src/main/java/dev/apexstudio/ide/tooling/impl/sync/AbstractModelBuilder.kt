...
import dev.apexstudio.ide.builder.model.IDESyncIssue
import dev.apexstudio.ide.tooling.api.util.ToolingProps
import dev.apexstudio.ide.utils.AndroidPluginVersion
import dev.apexstudio.ide.utils.AndroidPluginVersion.Companion.MINIMUM_SUPPORTED
import dev.apexstudio.ide.utils.ILogger
import dev.apexstudio.ide.utils.StacktraceUtils
...
abstract class AbstractModelBuilder<P, R> : IModelBuilder<P, R> {
    companion object {
         ...
         * [ generateMessage(Object...)][dev.apexstudio.ide.utils.ILogger.generateMessage] in [ILogger][dev.apexstudio.ide.utils.ILogger].
         *
