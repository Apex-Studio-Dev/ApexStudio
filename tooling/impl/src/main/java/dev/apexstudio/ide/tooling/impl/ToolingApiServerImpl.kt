...
package dev.apexstudio.ide.tooling.impl

import dev.apexstudio.ide.tooling.api.IToolingApiClient
import dev.apexstudio.ide.tooling.api.IToolingApiServer
import dev.apexstudio.ide.tooling.api.messages.GradleDistributionParams
import dev.apexstudio.ide.tooling.api.messages.GradleDistributionType
...
import dev.apexstudio.ide.tooling.api.messages.result.BuildCancellationRequestResult
import dev.apexstudio.ide.tooling.api.messages.result.BuildCancellationRequestResult.Reason.CANCELLATION_ERROR
import dev.apexstudio.ide.tooling.api.messages.result.BuildInfo
import dev.apexstudio.ide.tooling.api.messages.result.BuildResult
...
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.BUILD_CANCELLED
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.BUILD_FAILED
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.CONNECTION_CLOSED
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.CONNECTION_ERROR
...
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_INITIALIZED
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.UNKNOWN
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_BUILD_ARGUMENT
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_CONFIGURATION
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_GRADLE_VERSION
...
import dev.apexstudio.ide.tooling.impl.sync.RootModelBuilder
import dev.apexstudio.ide.tooling.impl.sync.RootProjectModelBuilderParams
import dev.apexstudio.ide.tooling.impl.util.configureFrom
import dev.apexstudio.ide.utils.StopWatch
import dev.apexstudio.ide.utils.withStopWatch
...
internal class ToolingApiServerImpl : IToolingApiServer {
	...
	override fun shutdown(): CompletableFuture<Void> =
		CompletableFuture.supplyAsync {
			...
			// see dev.apexstudio.ide.tooling.impl.Main.main(String[])
