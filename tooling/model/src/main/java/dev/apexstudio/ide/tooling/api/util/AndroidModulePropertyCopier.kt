...
import dev.apexstudio.ide.builder.model.DefaultAndroidGradlePluginProjectFlags
import dev.apexstudio.ide.builder.model.DefaultAndroidLibraryData
import dev.apexstudio.ide.builder.model.DefaultApiVersion
import dev.apexstudio.ide.builder.model.DefaultArtifactDependencies
import dev.apexstudio.ide.builder.model.DefaultCustomSourceDirectory
import dev.apexstudio.ide.builder.model.DefaultGraphItem
import dev.apexstudio.ide.builder.model.DefaultJavaCompileOptions
import dev.apexstudio.ide.builder.model.DefaultLibrary
import dev.apexstudio.ide.builder.model.DefaultLibraryInfo
import dev.apexstudio.ide.builder.model.DefaultProjectInfo
import dev.apexstudio.ide.builder.model.DefaultProjectSyncIssues
import dev.apexstudio.ide.builder.model.DefaultSourceProvider
import dev.apexstudio.ide.builder.model.DefaultSourceSetContainer
import dev.apexstudio.ide.builder.model.DefaultSyncIssue
import dev.apexstudio.ide.builder.model.DefaultUnresolvedDependency
import dev.apexstudio.ide.builder.model.DefaultViewBindingOptions
