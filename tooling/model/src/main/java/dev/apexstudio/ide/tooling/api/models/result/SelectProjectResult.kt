...
package dev.apexstudio.ide.tooling.api.models.result

/**
 * Result sent to the client when selecting a project in [IProjectQueries][dev.apexstudio.ide.tooling.api.IProjectQueries].
 *
