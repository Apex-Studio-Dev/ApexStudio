...
package dev.apexstudio.ide.zipfs2;

import java.nio.file.Paths;
import java.util.Collections;
import java.util.Map;

import static dev.apexstudio.ide.zipfs2.ZipConstants.*;
import static dev.apexstudio.ide.zipfs2.ZipUtils.dosToJavaTime;
import static dev.apexstudio.ide.zipfs2.ZipUtils.unixToJavaTime;
import static dev.apexstudio.ide.zipfs2.ZipUtils.winToJavaTime;
