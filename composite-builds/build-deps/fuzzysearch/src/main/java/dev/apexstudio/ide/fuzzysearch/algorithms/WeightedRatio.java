...
import static dev.apexstudio.ide.fuzzysearch.FuzzySearch.partialRatio;
import static dev.apexstudio.ide.fuzzysearch.FuzzySearch.ratio;
import static dev.apexstudio.ide.fuzzysearch.FuzzySearch.tokenSetPartialRatio;
import static dev.apexstudio.ide.fuzzysearch.FuzzySearch.tokenSetRatio;
import static dev.apexstudio.ide.fuzzysearch.FuzzySearch.tokenSortPartialRatio;
import static dev.apexstudio.ide.fuzzysearch.FuzzySearch.tokenSortRatio;
import static dev.apexstudio.ide.fuzzysearch.algorithms.PrimitiveUtils.max;
import static java.lang.Math.round;

import dev.apexstudio.ide.fuzzysearch.ToStringFunction;
