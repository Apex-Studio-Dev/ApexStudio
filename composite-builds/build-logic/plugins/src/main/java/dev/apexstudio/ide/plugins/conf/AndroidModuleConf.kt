...
package dev.apexstudio.ide.plugins.conf
...
import dev.apexstudio.ide.build.config.projectVersionCode
...
fun Project.configureAndroidModule(
  ...
  extensions.getByType(BaseExtension::class.java).run {
    ...
    if (project.plugins.hasPlugin("dev.apexstudio.ide.core-app")) {
      packagingOptions {
        jniLibs {
