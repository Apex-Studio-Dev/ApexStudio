...
import dev.apexstudio.ide.build.config.KEY_ALIAS
import dev.apexstudio.ide.build.config.KEY_PASS
import dev.apexstudio.ide.build.config.KEY_STORE_PASS
import dev.apexstudio.ide.build.config.isFDroidBuild
import dev.apexstudio.ide.build.config.signingKey
import dev.apexstudio.ide.plugins.util.SigningKeyUtils.downloadSigningKey
import dev.apexstudio.ide.plugins.util.SigningKeyUtils.getEnvOrProp
