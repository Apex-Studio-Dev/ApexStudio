...
package dev.apexstudio.ide.build.propparser.gen;

import static java.util.stream.Collectors.toList;

import dev.apexstudio.ide.build.propparser.parser.Message;
import dev.apexstudio.ide.build.propparser.parser.MessageFile;
import dev.apexstudio.ide.build.propparser.parser.MessageInfo;
import dev.apexstudio.ide.build.propparser.parser.MessageLine;
import dev.apexstudio.ide.build.propparser.parser.MessageType;
import dev.apexstudio.ide.build.propparser.parser.MessageType.CompoundType;
import dev.apexstudio.ide.build.propparser.parser.MessageType.CustomType;
import dev.apexstudio.ide.build.propparser.parser.MessageType.SimpleType;
import dev.apexstudio.ide.build.propparser.parser.MessageType.UnionType;
import dev.apexstudio.ide.build.propparser.parser.MessageType.Visitor;
