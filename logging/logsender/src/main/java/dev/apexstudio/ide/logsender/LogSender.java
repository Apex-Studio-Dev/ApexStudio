...
package dev.apexstudio.ide.logsender;
...
import dev.apexstudio.ide.logsender.utils.LogReader;
import dev.apexstudio.ide.logsender.utils.Logger;
...
public final class LogSender extends ILogSender.Stub implements ServiceConnection {
   ...
   */
  public static final String SERVICE_ACTION = "dev.apexstudio.ide.LOG_SERVICE_ACTION";
  /**
   ...
   */
  public static final String PACKAGE_ANDROIDIDE = "dev.apexstudio.ide";
