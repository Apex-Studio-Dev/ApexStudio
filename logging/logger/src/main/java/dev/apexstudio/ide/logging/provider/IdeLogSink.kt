...
package dev.apexstudio.ide.logging.provider

//import dev.apexstudio.ide.logging.utils.LogUtils
...
object IdeLogRouter {
	 ...
	 * Used by [dev.apexstudio.ide.services.builder.ToolingServerRunner] to pass the app's
