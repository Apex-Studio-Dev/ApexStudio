...
This patch release primarily focuses on making AndroidIDE available on [F-Droid](https://f-droid.org/packages/dev.apexstudio.ide/) and includes some minor fixes.
