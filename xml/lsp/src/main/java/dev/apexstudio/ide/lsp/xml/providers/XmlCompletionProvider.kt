...
package dev.apexstudio.ide.lsp.xml.providers
...
import dev.apexstudio.ide.lsp.api.AbstractServiceProvider
...
import dev.apexstudio.ide.lsp.models.CompletionResult.Companion.EMPTY
import dev.apexstudio.ide.lsp.xml.providers.completion.AttrValueCompletionProvider
import dev.apexstudio.ide.lsp.xml.providers.completion.IXmlCompletionProvider
import dev.apexstudio.ide.lsp.xml.providers.completion.canCompleteManifest
import dev.apexstudio.ide.lsp.xml.providers.completion.common.CommonAttrCompletionProvider
import dev.apexstudio.ide.lsp.xml.providers.completion.etc.InheritingAttrCompletionProvider
import dev.apexstudio.ide.lsp.xml.providers.completion.layout.LayoutAttrCompletionProvider
import dev.apexstudio.ide.lsp.xml.providers.completion.layout.LayoutTagCompletionProvider
import dev.apexstudio.ide.lsp.xml.providers.completion.manifest.ManifestAttrCompletionProvider
import dev.apexstudio.ide.lsp.xml.providers.completion.manifest.ManifestAttrValueCompletionProvider
import dev.apexstudio.ide.lsp.xml.providers.completion.manifest.ManifestTagCompletionProvider
import dev.apexstudio.ide.lsp.xml.utils.AnimTagTransformer
import dev.apexstudio.ide.lsp.xml.utils.AnimatorTagTransformer
import dev.apexstudio.ide.lsp.xml.utils.DrawableTagTransformer
import dev.apexstudio.ide.lsp.xml.utils.ITagTransformer
import dev.apexstudio.ide.lsp.xml.utils.MenuTagTransformer
import dev.apexstudio.ide.lsp.xml.utils.NoOpTagTransformer
import dev.apexstudio.ide.lsp.xml.utils.TransitionTagTransformer
import dev.apexstudio.ide.lsp.xml.utils.XmlUtils
import dev.apexstudio.ide.lsp.xml.utils.XmlUtils.NodeType
import dev.apexstudio.ide.lsp.xml.utils.XmlUtils.NodeType.ATTRIBUTE
import dev.apexstudio.ide.lsp.xml.utils.XmlUtils.NodeType.ATTRIBUTE_VALUE
import dev.apexstudio.ide.lsp.xml.utils.XmlUtils.NodeType.TAG
import dev.apexstudio.ide.lsp.xml.utils.XmlUtils.NodeType.UNKNOWN
import dev.apexstudio.ide.lsp.xml.utils.forTransitionAttr
import dev.apexstudio.ide.utils.CharSequenceReader
