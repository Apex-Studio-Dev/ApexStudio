...
package dev.apexstudio.ide.uidesigner.adapters
...
import dev.apexstudio.ide.inflater.IView.SingleAttributeChangeListener
import dev.apexstudio.ide.uidesigner.R
import dev.apexstudio.ide.uidesigner.adapters.ViewAttrListAdapter.VH
import dev.apexstudio.ide.uidesigner.databinding.LayoutViewattrItemBinding
...
internal class ViewAttrListAdapter(
    attributes: List<dev.apexstudio.ide.inflater.IAttribute>,
    private val viewModel: WorkspaceViewModel?,
    private val onDeleteAttr: (dev.apexstudio.ide.inflater.IAttribute) -> Boolean,
    private val onClick: (dev.apexstudio.ide.inflater.IAttribute) -> Unit,
