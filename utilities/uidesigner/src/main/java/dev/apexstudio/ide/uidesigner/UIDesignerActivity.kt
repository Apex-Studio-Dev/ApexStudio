...
import dev.apexstudio.ide.actions.ActionItem.Location.UI_DESIGNER_TOOLBAR
...
import dev.apexstudio.ide.uidesigner.actions.clearUiDesignerActions
import dev.apexstudio.ide.uidesigner.actions.registerUiDesignerActions
import dev.apexstudio.ide.uidesigner.databinding.ActivityUiDesignerBinding
import dev.apexstudio.ide.uidesigner.R
import dev.apexstudio.ide.uidesigner.fragments.DesignerWorkspaceFragment
import dev.apexstudio.ide.uidesigner.utils.ViewToXml
...
class UIDesignerActivity : BaseIDEActivity() {
  ...
  fun setupHierarchy(view: dev.apexstudio.ide.inflater.IView) {
