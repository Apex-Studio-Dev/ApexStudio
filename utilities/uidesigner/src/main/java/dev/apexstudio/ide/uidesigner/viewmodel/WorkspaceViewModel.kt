...
package dev.apexstudio.ide.uidesigner.viewmodel
...
internal class WorkspaceViewModel : ViewModel() {
  ...
  internal val _view = MutableLiveData<dev.apexstudio.ide.inflater.IView>(null)
  ...
  var view: dev.apexstudio.ide.inflater.IView?
