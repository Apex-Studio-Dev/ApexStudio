...
import dev.apexstudio.ide.uidesigner.undo.ViewAddedAction
import dev.apexstudio.ide.uidesigner.undo.ViewMovedAction
import dev.apexstudio.ide.uidesigner.undo.ViewRemovedAction
...
internal class WorkspaceViewHierarchyHandler : IViewGroup.SingleOnHierarchyChangeListener() {
  ...
  override fun beforeViewAdded(group: IViewGroup, view: dev.apexstudio.ide.inflater.IView, index: Int) {
    animateLayoutChange()
  }
  ...
  override fun onViewAdded(group: IViewGroup, view: dev.apexstudio.ide.inflater.IView, index: Int) {
    val frag = this.fragment ?: return
  ...
  override fun onViewRemoved(group: IViewGroup, view: dev.apexstudio.ide.inflater.IView, index: Int) {
    val frag = this.fragment ?: return
