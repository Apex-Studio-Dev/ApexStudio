...
package dev.apexstudio.ide.uidesigner.views
...
constructor(
  ...
  private fun addViews(view: IView, depth: Int) {
    ...
    if (view is dev.apexstudio.ide.inflater.IViewGroup) {
  ...
  private fun computeChildCount(view: dev.apexstudio.ide.inflater.IViewGroup): Int {
    var count = view.childCount
    view.forEachIndexed { index, child ->
      if (index != view.childCount - 1 && child is dev.apexstudio.ide.inflater.IViewGroup) {
