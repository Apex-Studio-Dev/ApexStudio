...
package dev.apexstudio.ide.uidesigner.undo
...
class ViewMovedAction(
    private val child: dev.apexstudio.ide.inflater.IView,
    private val fromParent: dev.apexstudio.ide.inflater.IViewGroup,
    private val toParent: dev.apexstudio.ide.inflater.IViewGroup,
