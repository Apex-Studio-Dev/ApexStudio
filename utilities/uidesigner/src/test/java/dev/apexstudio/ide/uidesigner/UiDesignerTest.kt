...
package dev.apexstudio.ide.uidesigner
...
import dev.apexstudio.ide.inflater.internal.utils.ViewFactory
import dev.apexstudio.ide.inflater.viewGroup
import dev.apexstudio.ide.lookup.Lookup
import dev.apexstudio.ide.uidesigner.utils.UiInflaterComponentFactory
...
fun Context.createLayout(parent: dev.apexstudio.ide.inflater.IViewGroup? = null): ViewGroupImpl {
...
fun Context.createView(parent: dev.apexstudio.ide.inflater.IViewGroup? = null): ViewImpl {
  return ViewImpl(LayoutFile(File(""), ""), View::class.qualifiedName!!, View(this)).apply {
    parent?.let { applyLayoutParams(it) }
  }
}

fun ViewImpl.applyLayoutParams(parent: dev.apexstudio.ide.inflater.IViewGroup) {
