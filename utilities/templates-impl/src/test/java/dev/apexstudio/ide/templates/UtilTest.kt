...
import dev.apexstudio.ide.templates.ParameterConstraint.CLASS
import dev.apexstudio.ide.templates.ParameterConstraint.CLASS_NAME
...
import dev.apexstudio.ide.templates.ParameterConstraint.FILE
import dev.apexstudio.ide.templates.ParameterConstraint.LAYOUT
...
import dev.apexstudio.ide.templates.ParameterConstraint.PACKAGE
import dev.apexstudio.ide.templates.base.util.isValidModuleName
import dev.apexstudio.ide.templates.base.util.moduleNameToDirName
...
class UtilTest {
  ...
  fun `test constraint verifier`() {
    ConstraintVerifier.apply {
      ...
      assertThat(isValid("dev.apexstudio.ide", listOf(PACKAGE))).isTrue()
