 ...
 * - [ViewAdapter][dev.apexstudio.ide.annotations.inflater.ViewAdapter] is used to specify the
 *   view whose attributes are handled by the view adapter implementation.
 * - [IncludeInDesigner][dev.apexstudio.ide.annotations.uidesigner.IncludeInDesigner] is used to
...
abstract class IViewAdapter<T : View> : AbstractParser() {
   ...
   * [ViewAdapter][dev.apexstudio.ide.annotations.inflater.ViewAdapter] annotation.
   *
