...
package dev.apexstudio.ide.inflater.vectormaster.models;
...
import dev.apexstudio.ide.inflater.vectormaster.DefaultValues;
import dev.apexstudio.ide.inflater.vectormaster.utilities.Utils;
import dev.apexstudio.ide.inflater.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
  ...
  public void buildPath(boolean useLegacyParser) {
    if (useLegacyParser) {
      originalPath =
          dev.apexstudio.ide.inflater.vectormaster.utilities.legacyparser.PathParser.createPathFromPathData(
              pathData);
    } else {
