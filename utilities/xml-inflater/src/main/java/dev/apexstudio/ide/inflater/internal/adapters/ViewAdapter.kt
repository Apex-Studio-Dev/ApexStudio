...
import dev.apexstudio.ide.inflater.IViewAdapter
import dev.apexstudio.ide.inflater.internal.IncludeView
import dev.apexstudio.ide.inflater.models.UiWidget
import dev.apexstudio.ide.inflater.utils.newAttribute
...
open class ViewAdapter<T : View> : IViewAdapter<T>() {
  ...
  protected open fun parseDrawingCacheQuality(value: String): Int {
    return dev.apexstudio.ide.inflater.internal.utils.parseDrawingCacheQuality(value)
  }

  protected open fun parseVisibility(value: String): Int {
    return dev.apexstudio.ide.inflater.internal.utils.parseVisibility(value)
  }

  protected open fun parseTextAlignment(value: String): Int {
    return dev.apexstudio.ide.inflater.internal.utils.parseTextAlignment(value)
  }

  protected open fun parseTextDirection(value: String): Int {
    return dev.apexstudio.ide.inflater.internal.utils.parseTextDirection(value)
  }

  protected open fun parsePorterDuffMode(mode: String): PorterDuff.Mode {
    return dev.apexstudio.ide.inflater.internal.utils.parsePorterDuffMode(mode)
  }
