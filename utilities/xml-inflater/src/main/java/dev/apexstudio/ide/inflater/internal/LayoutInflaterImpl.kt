...
package dev.apexstudio.ide.inflater.internal
...
import dev.apexstudio.ide.inflater.DefaultComponentFactory
import dev.apexstudio.ide.inflater.IAttribute
import dev.apexstudio.ide.inflater.IComponentFactory
import dev.apexstudio.ide.inflater.IComponentFactory.Companion.LAYOUT_INFLATER_COMPONENT_FACTORY_KEY
import dev.apexstudio.ide.inflater.ILayoutInflater
import dev.apexstudio.ide.inflater.INamespace
import dev.apexstudio.ide.inflater.IView
import dev.apexstudio.ide.inflater.IViewGroup
import dev.apexstudio.ide.inflater.InflateException
import dev.apexstudio.ide.inflater.events.IInflateEventsListener
import dev.apexstudio.ide.inflater.events.InflationFinishEvent
import dev.apexstudio.ide.inflater.events.InflationStartEvent
import dev.apexstudio.ide.inflater.events.OnApplyAttributeEvent
import dev.apexstudio.ide.inflater.events.OnInflateViewEvent
import dev.apexstudio.ide.inflater.internal.utils.IDTable
import dev.apexstudio.ide.inflater.internal.utils.ViewFactory.createViewInstance
import dev.apexstudio.ide.inflater.internal.utils.ViewFactory.generateLayoutParams
import dev.apexstudio.ide.inflater.internal.utils.parseLayoutReference
import dev.apexstudio.ide.inflater.utils.endParse
import dev.apexstudio.ide.inflater.utils.isParsing
import dev.apexstudio.ide.inflater.utils.startParse
import dev.apexstudio.ide.inflater.viewAdapter
import dev.apexstudio.ide.lookup.Lookup
import dev.apexstudio.ide.projects.api.AndroidModule
import dev.apexstudio.ide.xml.widgets.Widget
import dev.apexstudio.ide.xml.widgets.WidgetTable
import dev.apexstudio.ide.xml.widgets.WidgetType
import java.io.File
...
open class LayoutInflaterImpl : ILayoutInflater {
  ...
  protected open fun processXmlFile(file: File): Pair<XmlProcessor, AndroidModule> {
    return dev.apexstudio.ide.inflater.utils.processXmlFile(file, LAYOUT)
  }
  ...
  private fun startInflation(file: File) {
    ...
    if (!isParsing) {
      if (this.module == null) {
        startParse(file)
        this.module = dev.apexstudio.ide.inflater.utils.module
      } else {
