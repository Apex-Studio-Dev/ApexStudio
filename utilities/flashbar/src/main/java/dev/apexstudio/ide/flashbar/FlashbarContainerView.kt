...
package dev.apexstudio.ide.flashbar
...
import dev.apexstudio.ide.flashbar.Flashbar.Companion.DURATION_INDEFINITE
import dev.apexstudio.ide.flashbar.Flashbar.DismissEvent
import dev.apexstudio.ide.flashbar.Flashbar.DismissEvent.*
import dev.apexstudio.ide.flashbar.Flashbar.Vibration.DISMISS
import dev.apexstudio.ide.flashbar.SwipeDismissTouchListener.DismissCallbacks
import dev.apexstudio.ide.flashbar.anim.FlashAnim
import dev.apexstudio.ide.flashbar.Flashbar.OnBarDismissListener
import dev.apexstudio.ide.flashbar.Flashbar.OnBarShowListener
import dev.apexstudio.ide.flashbar.Flashbar.OnTapListener
import dev.apexstudio.ide.flashbar.Flashbar.Vibration
import dev.apexstudio.ide.flashbar.Flashbar.Vibration.SHOW
import dev.apexstudio.ide.flashbar.anim.FlashAnimBarBuilder
import dev.apexstudio.ide.flashbar.anim.FlashAnimIconBuilder
import dev.apexstudio.ide.flashbar.util.NavigationBarPosition.*
import dev.apexstudio.ide.flashbar.util.afterMeasured
import dev.apexstudio.ide.flashbar.util.getNavigationBarPosition
import dev.apexstudio.ide.flashbar.util.getNavigationBarSizeInPx
import dev.apexstudio.ide.flashbar.util.getRootView
