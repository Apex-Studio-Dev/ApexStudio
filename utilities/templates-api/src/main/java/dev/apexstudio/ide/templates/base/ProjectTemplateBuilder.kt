...
import dev.apexstudio.ide.templates.base.root.buildGradleSrcGroovy
import dev.apexstudio.ide.templates.base.root.buildGradleSrcKts
import dev.apexstudio.ide.templates.base.root.gradleWrapperProps
import dev.apexstudio.ide.templates.base.root.settingsGradleSrcStr
import dev.apexstudio.ide.templates.base.util.optonallyKts
import dev.apexstudio.ide.utils.transferToStream
import java.io.File
...
class ProjectTemplateBuilder :
  ...
  fun baseAsset(path: String) =
    dev.apexstudio.ide.templates.base.util.baseAsset("root", path)
