...
import dev.apexstudio.ide.templates.SrcSet
import dev.apexstudio.ide.templates.TemplateBuilder
import dev.apexstudio.ide.templates.TemplateRecipeConfigurator
import dev.apexstudio.ide.templates.TemplateRecipeFinalizer
import dev.apexstudio.ide.templates.base.models.Dependency
import dev.apexstudio.ide.templates.base.models.defaultDependency
...
abstract class ModuleTemplateBuilder :
   ...
   * @see dev.apexstudio.ide.templates.base.baseAsset
   */
  open fun baseAsset(path: String) =
    dev.apexstudio.ide.templates.base.util.baseAsset("module", path)
   ...
   * [Implementation][dev.apexstudio.ide.templates.base.models.DependencyConfiguration.Implementation]
   * configuration.
   *
