 ...
 */
package dev.apexstudio.ide.fragments.sidebar
...
import dev.apexstudio.ide.adapters.viewholders.FileTreeViewHolder
import dev.apexstudio.ide.databinding.LayoutEditorFileTreeBinding
import dev.apexstudio.ide.eventbus.events.filetree.FileClickEvent
import dev.apexstudio.ide.eventbus.events.filetree.FileLongClickEvent
import dev.apexstudio.ide.projects.IProjectManager
import dev.apexstudio.ide.resources.R.drawable
import dev.apexstudio.ide.tasks.TaskExecutor.executeAsync
import dev.apexstudio.ide.tasks.callables.FileTreeCallable
import dev.apexstudio.ide.tasks.callables.FileTreeCallable.SortFileName
import dev.apexstudio.ide.tasks.callables.FileTreeCallable.SortFolder
import dev.apexstudio.ide.utils.doOnApplyWindowInsets
import dev.apexstudio.ide.viewmodel.FileTreeViewModel
...
import dev.apexstudio.ide.events.ExpandTreeNodeRequestEvent
import dev.apexstudio.ide.events.ListProjectFilesRequestEvent
