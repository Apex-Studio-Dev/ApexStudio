...
import dev.apexstudio.ide.app.IDEActivity;
import dev.apexstudio.ide.databinding.ActivityCrashHandlerBinding;
import dev.apexstudio.ide.fragments.CrashReportFragment;

public class CrashHandlerActivity extends IDEActivity {

  public static final String REPORT_ACTION = "dev.apexstudio.ide.REPORT_CRASH";
