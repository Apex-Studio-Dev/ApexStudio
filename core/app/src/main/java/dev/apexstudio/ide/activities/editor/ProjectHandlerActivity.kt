...
package dev.apexstudio.ide.activities.editor
...
import dev.apexstudio.ide.actions.ActionsRegistry.Companion.getInstance
import dev.apexstudio.ide.actions.etc.FindInFileAction
import dev.apexstudio.ide.actions.etc.FindInProjectAction
import dev.apexstudio.ide.actions.internal.DefaultActionsRegistry
import dev.apexstudio.ide.databinding.LayoutSearchProjectBinding
import dev.apexstudio.ide.flashbar.Flashbar
import dev.apexstudio.ide.fragments.FindActionDialog
import dev.apexstudio.ide.fragments.sheets.ProgressSheet
import dev.apexstudio.ide.handlers.EditorBuildEventListener
import dev.apexstudio.ide.handlers.LspHandler.connectClient
import dev.apexstudio.ide.handlers.LspHandler.destroyLanguageServers
import dev.apexstudio.ide.lookup.Lookup
import dev.apexstudio.ide.lsp.IDELanguageClientImpl
import dev.apexstudio.ide.lsp.java.utils.CancelChecker
...
import dev.apexstudio.ide.projects.models.projectDir
import dev.apexstudio.ide.services.builder.GradleBuildService
import dev.apexstudio.ide.services.builder.GradleBuildServiceConnnection
import dev.apexstudio.ide.services.builder.gradleDistributionParams
import dev.apexstudio.ide.tooling.api.messages.AndroidInitializationParams
...
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.CACHE_READ_ERROR
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_DIRECTORY_INACCESSIBLE
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_DIRECTORY
import dev.apexstudio.ide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_FOUND
import dev.apexstudio.ide.tooling.api.messages.result.failure
import dev.apexstudio.ide.tooling.api.messages.result.isSuccessful
import dev.apexstudio.ide.tooling.api.models.BuildVariantInfo
import dev.apexstudio.ide.tooling.api.models.mapToSelectedVariants
import dev.apexstudio.ide.utils.DURATION_INDEFINITE
import dev.apexstudio.ide.utils.DialogUtils.newMaterialDialogBuilder
import dev.apexstudio.ide.utils.RecursiveFileSearcher
import dev.apexstudio.ide.tooling.api.sync.ProjectSyncHelper
import dev.apexstudio.ide.utils.flashError
import dev.apexstudio.ide.utils.flashSuccess
import dev.apexstudio.ide.utils.flashbarBuilder
import dev.apexstudio.ide.utils.resolveAttr
import dev.apexstudio.ide.utils.showOnUiThread
import dev.apexstudio.ide.utils.withIcon
import dev.apexstudio.ide.viewmodel.BuildState
import dev.apexstudio.ide.viewmodel.BuildVariantsViewModel
import dev.apexstudio.ide.viewmodel.BuildViewModel
...
//          Sentry.captureException(error)
  ...
  private fun updateBuildVariants(buildVariants: Map<String, BuildVariantInfo>) {
    ...
    dev.apexstudio.ide.tasks.runOnUiThread {
