...
import dev.apexstudio.ide.adapters.DiagnosticsAdapter
import dev.apexstudio.ide.adapters.SearchListAdapter
import dev.apexstudio.ide.app.EdgeToEdgeIDEActivity
import dev.apexstudio.ide.databinding.ActivityEditorBinding
import dev.apexstudio.ide.databinding.ContentEditorBinding
import dev.apexstudio.ide.databinding.LayoutDiagnosticInfoBinding
import dev.apexstudio.ide.events.InstallationResultEvent
import dev.apexstudio.ide.fragments.SearchResultFragment
import dev.apexstudio.ide.fragments.sidebar.EditorSidebarFragment
import dev.apexstudio.ide.fragments.sidebar.FileTreeFragment
import dev.apexstudio.ide.handlers.EditorActivityLifecyclerObserver
import dev.apexstudio.ide.handlers.LspHandler.registerLanguageServers
import dev.apexstudio.ide.interfaces.DiagnosticClickListener
import dev.apexstudio.ide.lookup.Lookup
import dev.apexstudio.ide.lsp.models.DiagnosticItem
import dev.apexstudio.ide.models.DiagnosticGroup
import dev.apexstudio.ide.models.OpenedFile
import dev.apexstudio.ide.models.Range
import dev.apexstudio.ide.models.SearchResult
import dev.apexstudio.ide.preferences.internal.BuildPreferences
...
import dev.apexstudio.ide.ui.CodeEditorView
import dev.apexstudio.ide.ui.ContentTranslatingDrawerLayout
import dev.apexstudio.ide.ui.SwipeRevealLayout
import dev.apexstudio.ide.uidesigner.UIDesignerActivity
import dev.apexstudio.ide.utils.ActionMenuUtils.createMenu
import dev.apexstudio.ide.utils.DialogUtils.newMaterialDialogBuilder
import dev.apexstudio.ide.utils.InstallationResultHandler.onResult
import dev.apexstudio.ide.utils.IntentUtils
import dev.apexstudio.ide.utils.MemoryUsageWatcher
import dev.apexstudio.ide.utils.flashError
import dev.apexstudio.ide.utils.resolveAttr
import dev.apexstudio.ide.viewmodel.ApkInstallationViewModel
import dev.apexstudio.ide.viewmodel.AppLogsCoordinator
import dev.apexstudio.ide.viewmodel.AppLogsViewModel
import dev.apexstudio.ide.viewmodel.BottomSheetViewModel
import dev.apexstudio.ide.viewmodel.EditorViewModel
import dev.apexstudio.ide.xml.resources.ResourceTableRegistry
import dev.apexstudio.ide.xml.versions.ApiVersionsRegistry
import dev.apexstudio.ide.xml.widgets.WidgetTableRegistry
