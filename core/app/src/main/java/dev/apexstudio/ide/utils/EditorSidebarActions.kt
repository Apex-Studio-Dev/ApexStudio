...
import dev.apexstudio.ide.actions.SidebarActionItem
import dev.apexstudio.ide.actions.internal.DefaultActionsRegistry
import dev.apexstudio.ide.actions.sidebar.BuildVariantsSidebarAction
import dev.apexstudio.ide.actions.sidebar.CloseProjectSidebarAction
import dev.apexstudio.ide.actions.sidebar.FileTreeSidebarAction
import dev.apexstudio.ide.actions.sidebar.PreferencesSidebarAction
import dev.apexstudio.ide.actions.sidebar.TerminalSidebarAction
 ...
 * [EditorActivityKt][dev.apexstudio.ide.activities.editor.EditorActivityKt]'s drawer's sidebar.
 *
 * @author Akash Yadav
 */
