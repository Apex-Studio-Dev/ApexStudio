...
import dev.apexstudio.ide.databinding.LayoutMainActionItemBinding
...
constructor(val actions: List<MainScreenAction> = emptyList()) :
  ...
  override fun onBindViewHolder(holder: VH, position: Int) {
    ...
    binding.root.apply {
      binding.tvText.text = binding.tvText.context.getString(action.text)
      binding.icIcon.setImageResource(action.icon)
      setOnClickListener {
