 ...
 */
package dev.apexstudio.ide.window
...
import dev.apexstudio.ide.window.ActivityCompatHelperApi24.isInMultiWindowMode
import dev.apexstudio.ide.window.ActivityCompatHelperApi30.currentWindowBounds
import dev.apexstudio.ide.window.ActivityCompatHelperApi30.maximumWindowBounds
import dev.apexstudio.ide.window.DisplayCompatHelperApi17.getRealSize
import dev.apexstudio.ide.window.DisplayCompatHelperApi28.safeInsetBottom
import dev.apexstudio.ide.window.DisplayCompatHelperApi28.safeInsetLeft
import dev.apexstudio.ide.window.DisplayCompatHelperApi28.safeInsetRight
import dev.apexstudio.ide.window.DisplayCompatHelperApi28.safeInsetTop
