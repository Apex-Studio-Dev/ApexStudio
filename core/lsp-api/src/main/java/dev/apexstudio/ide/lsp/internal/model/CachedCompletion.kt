...
package dev.apexstudio.ide.lsp.internal.model
...
private constructor(
  ...
  val result: dev.apexstudio.ide.lsp.models.CompletionResult
) {
  ...
  companion object {
    ...
    val EMPTY =
      cache(
        CompletionParams(
          dev.apexstudio.ide.models.Position.NONE,
          Paths.get(""), ICancelChecker.CANCELLED
        ),
        dev.apexstudio.ide.lsp.models.CompletionResult.EMPTY
      )
    ...
    fun cache(
      ...
      result: dev.apexstudio.ide.lsp.models.CompletionResult
    ): CachedCompletion {
      val params =
