...
package dev.apexstudio.ide.lsp.java.indexing

import androidx.test.ext.junit.runners.AndroidJUnit4
import com.google.common.truth.Truth.assertThat
import dev.apexstudio.ide.indexing.core.platform.ApiInfo
import dev.apexstudio.ide.lsp.java.indexing.classfile.ArrayAnnotationElementValue
import dev.apexstudio.ide.lsp.java.indexing.classfile.ClassAnnotationElementValue
import dev.apexstudio.ide.lsp.java.indexing.classfile.EnumAnnotationElementValue
import dev.apexstudio.ide.lsp.java.indexing.classfile.IAnnotationElementValue
import dev.apexstudio.ide.lsp.java.indexing.classfile.JavaConstant
import dev.apexstudio.ide.lsp.java.utils.JavaType
import dev.apexstudio.ide.lsp.java.indexing.classfile.PrimitiveAnnotationElementValue
import dev.apexstudio.ide.testing.android.rules.RealmDBTestRule
...
class SharedModelCRUDTest {
  ...
  fun testApiInfoCreate() {
    dbTestRule.withDb("api-info") {
      val apiInfo = dev.apexstudio.ide.indexing.core.platform.ApiInfo.newInstance(since = 1, deprecatedIn = 21, removedIn = 23)
