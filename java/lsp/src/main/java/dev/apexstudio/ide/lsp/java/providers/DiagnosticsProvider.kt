...
import dev.apexstudio.ide.lsp.java.models.DiagnosticCode.EMPTY_BLOCK
import dev.apexstudio.ide.lsp.java.models.DiagnosticCode.UNUSED_THROWS
import dev.apexstudio.ide.lsp.java.visitors.DiagnosticVisitor
import dev.apexstudio.ide.lsp.models.DiagnosticItem
import dev.apexstudio.ide.lsp.models.DiagnosticSeverity
import dev.apexstudio.ide.lsp.models.DiagnosticSeverity.WARNING
...
import dev.apexstudio.ide.utils.DocumentUtils.isSameFile
...
object DiagnosticsProvider {
  ...
  private fun getPosition(position: Long, lines: LineMap): dev.apexstudio.ide.models.Position {
    abortIfCancelled()
    ...
    return dev.apexstudio.ide.models.Position(line, column)
  }
