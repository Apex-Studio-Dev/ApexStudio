...
package dev.apexstudio.ide.lsp.java.edits
...
class MultipleClassImportEditHandler(
  ...
  override fun performEdits(
    ...
    editor: CodeEditor,
    completionItem: dev.apexstudio.ide.lsp.models.CompletionItem
  ) {
    val edits = mutableListOf<dev.apexstudio.ide.lsp.models.TextEdit>()
    ...
    dev.apexstudio.ide.lsp.util.RewriteHelper.performEdits(edits, editor)
  }
}
