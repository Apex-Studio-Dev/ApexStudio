 ...
 */
package dev.apexstudio.ide.lsp.java.actions.generators
...
import dev.apexstudio.ide.lsp.java.compiler.CompilerProvider
import dev.apexstudio.ide.lsp.java.parser.ParseTask
import dev.apexstudio.ide.lsp.java.Rewrite.AddImport
import dev.apexstudio.ide.lsp.java.utils.EditHelper
import dev.apexstudio.ide.lsp.java.utils.FindHelper
import dev.apexstudio.ide.lsp.java.utils.JavaParserUtils
import dev.apexstudio.ide.lsp.java.utils.MethodPtr
import dev.apexstudio.ide.lsp.java.visitors.FindTypeDeclarationAt
...
class OverrideSuperclassMethodsAction : BaseJavaCodeAction() {
  ...
  override fun prepare(data: ActionData) {
    ...
    if (
      ...
      !data.hasRequiredData(
        dev.apexstudio.ide.models.Range::class.java,
  ...
  override suspend fun execAction(data: ActionData): Any {
    val range = data[dev.apexstudio.ide.models.Range::class.java]!!
    val compiler =
