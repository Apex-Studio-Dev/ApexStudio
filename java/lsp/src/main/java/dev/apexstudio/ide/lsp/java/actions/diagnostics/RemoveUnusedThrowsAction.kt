...
import dev.apexstudio.ide.lsp.java.Rewrite.RemoveException
import dev.apexstudio.ide.lsp.java.utils.CodeActionUtils
...
class RemoveUnusedThrowsAction : BaseJavaCodeAction() {
  ...
  override suspend fun execAction(data: ActionData): Any {
    val d = data[dev.apexstudio.ide.lsp.models.DiagnosticItem::class.java]!!
    val compiler =
