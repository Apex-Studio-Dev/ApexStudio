...
package dev.apexstudio.ide.lsp.java.compiler;

import static dev.apexstudio.ide.javac.config.JavacConfigProvider.PROP_ANDROIDIDE_JAVA_HOME;
import static dev.apexstudio.ide.javac.config.JavacConfigProvider.disableModules;
import static dev.apexstudio.ide.javac.config.JavacConfigProvider.enableModules;
import static dev.apexstudio.ide.javac.config.JavacConfigProvider.setLatestSourceVersion;
import static dev.apexstudio.ide.javac.config.JavacConfigProvider.setLatestSupportedSourceVersion;
import static dev.apexstudio.ide.utils.Environment.JAVA_HOME;

import androidx.annotation.NonNull;
import androidx.core.util.Pair;
import dev.apexstudio.ide.javac.services.compiler.ReusableBorrow;
import dev.apexstudio.ide.javac.services.partial.DiagnosticListenerImpl;
import dev.apexstudio.ide.lsp.java.models.CompilationRequest;
import dev.apexstudio.ide.lsp.java.visitors.MethodRangeScanner;
import dev.apexstudio.ide.models.Range;
import dev.apexstudio.ide.projects.api.ModuleProject;
import dev.apexstudio.ide.projects.util.StringSearch;
import dev.apexstudio.ide.utils.ClassTrie;
import dev.apexstudio.ide.utils.SourceClassTrie;
