...
import dev.apexstudio.ide.lsp.java.edits.MultipleClassImportEditHandler
import dev.apexstudio.ide.lsp.java.models.JavaCompletionItem
import dev.apexstudio.ide.lsp.java.utils.JavaPoetUtils.Companion.buildMethod
import dev.apexstudio.ide.lsp.java.utils.JavaPoetUtils.Companion.print
import dev.apexstudio.ide.lsp.java.utils.ScopeHelper
...
import dev.apexstudio.ide.progress.ProgressManager.Companion.abortIfCancelled
...
class ScopeCompletionProvider(
  ...
  private fun overrideIfPossible(
    ...
    item.completionKind = dev.apexstudio.ide.lsp.models.CompletionItemKind.METHOD
