...
import dev.apexstudio.ide.lsp.java.providers.CompletionProvider.MAX_COMPLETION_ITEMS
...
import dev.apexstudio.ide.utils.ClassTrie.Node
...
class ImportCompletionProvider(
   ...
   */
  private fun collectPackageNode(trie: dev.apexstudio.ide.utils.ClassTrie, pkgName: String): Node? {
